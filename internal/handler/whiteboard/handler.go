...
import (
	...
	wsvc "github.com/yourorg/clickup/internal/service/whiteboard"
)
...
func (h *Handler) Routes(r chi.Router) {
	r.Get("/workspaces/{workspaceID}/whiteboards", h.list)
	r.Post("/workspaces/{workspaceID}/whiteboards", h.create)
	r.Get("/whiteboards/{id}", h.get)
	r.Patch("/whiteboards/{id}", h.update)
	r.Delete("/whiteboards/{id}", h.delete)
}
